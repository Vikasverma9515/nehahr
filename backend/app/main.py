...
from app.routers import agent, ai_interviews, candidates, careers, offers, portal, reviews, calls, jobs, webhooks, interviewers, auth, interviews, hr_sender
...
app.include_router(ai_interviews.public_router, prefix="/api/ai-interviews", tags=["ai-interviews-public"])
app.include_router(ai_interviews.router, prefix="/api/ai-interviews", tags=["ai-interviews"], dependencies=authed)
app.include_router(portal.public_router, prefix="/api/portal/public", tags=["portal-public"])
app.include_router(portal.router, prefix="/api/portal", tags=["portal"], dependencies=authed)
app.include_router(reviews.public_router, prefix="/api/reviews", tags=["reviews-public"])
app.include_router(reviews.router, prefix="/api/reviews", tags=["reviews"], dependencies=authed)
app.include_router(offers.public_router, prefix="/api/offers", tags=["offers-public"])
app.include_router(offers.router, prefix="/api/offers", tags=["offers"], dependencies=authed)
app.include_router(careers.router, prefix="/api/careers", tags=["careers-public"])
