...
('bbbb0007-0000-0000-0000-000000000007', 'aaaa0007-0000-0000-0000-000000000007', 'screening', 'in_progress', NULL, 'outbound',
 'Neha: Hi Rajesh, this is Neha from the recruiting team...', NULL, NULL,
...
('cccc0001-0000-0000-0000-000000000001', 'aaaa0002-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 1, 'Anil Kapoor', 'anil@example.com', 'video', now() + interval '2 days', 'scheduled', 'pending', NULL, NULL, false, false, false),

-- Amit's interview (upcoming)
('cccc0002-0000-0000-0000-000000000002', 'aaaa0003-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', 1, 'Sanjay Mehta', 'sanjay@example.com', 'video', now() + interval '3 days', 'scheduled', 'pending', NULL, NULL, false, false, false),

-- Vikram's interview (completed with feedback)
('cccc0003-0000-0000-0000-000000000003', 'aaaa0005-0000-0000-0000-000000000005', '22222222-2222-2222-2222-222222222222', 1, 'Anil Kapoor', 'anil@example.com', 'in_person', now() - interval '2 days', 'completed', 'submitted', '{"technical": 4, "communication": 5, "culture_fit": 4, "overall": 4, "recommendation": "yes", "strengths": "Strong client relationships, excellent communication", "concerns": "Could improve on CRM tooling"}', 'pass', true, true, true),

-- Vikram's round 2 (upcoming)
('cccc0004-0000-0000-0000-000000000004', 'aaaa0005-0000-0000-0000-000000000005', '22222222-2222-2222-2222-222222222222', 2, 'Prateek Shah', 'prateek@example.com', 'video', now() + interval '1 day', 'scheduled', 'pending', NULL, NULL, false, false, false),

-- Neha Gupta's completed interviews
('cccc0005-0000-0000-0000-000000000005', 'aaaa0006-0000-0000-0000-000000000006', '22222222-2222-2222-2222-222222222222', 1, 'Anil Kapoor', 'anil@example.com', 'in_person', now() - interval '7 days', 'completed', 'submitted', '{"technical": 4, "communication": 5, "culture_fit": 5, "overall": 5, "recommendation": "strong_yes"}', 'pass', true, true, true),
('cccc0006-0000-0000-0000-000000000006', 'aaaa0006-0000-0000-0000-000000000006', '22222222-2222-2222-2222-222222222222', 2, 'Prateek Shah', 'prateek@example.com', 'video', now() - interval '4 days', 'completed', 'submitted', '{"technical": 5, "communication": 5, "culture_fit": 5, "overall": 5, "recommendation": "strong_yes"}', 'pass', true, true, true);
...
('Rohit Verma', '+919876543020', 'rohit@example.com', 'payroll', 'My April salary slip shows incorrect HRA amount. Can you check?', 'escalated', 'Payroll & Finance team', NULL),
('Anita Das', '+919876543021', 'anita@example.com', 'time_attendance', 'I need to regularize attendance for March 28 — I was working from home but it shows absent.', 'resolved', NULL, 'Attendance regularized for March 28. Marked as WFH.'),
('Karan Malhotra', '+919876543022', 'karan@example.com', 'it_helpdesk', 'VPN not connecting since yesterday. Getting timeout errors.', 'open', NULL, NULL),
('Meera Krishnan', '+919876543023', 'meera@example.com', 'hr_documentation', 'Need my experience letter — last day is April 30.', 'open', NULL, NULL);
