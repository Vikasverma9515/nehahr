...
export async function proxy(request: NextRequest) {
  ...
  if (!process.env.NEXT_PUBLIC_SUPABASE_URL || !process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY) {
    ...
    const isPublic = p === "/" || p.startsWith("/login") || p.startsWith("/signup") || p.startsWith("/feedback") || p.startsWith("/interview") || p.startsWith("/c/") || p.startsWith("/review/") || p.startsWith("/offer/") || p.startsWith("/careers") || p.startsWith("/auth/callback");
